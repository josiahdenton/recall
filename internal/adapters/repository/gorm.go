...
func (g GormInstance) ModifyStatus(status domain.Status) domain.Status {
...
func (g GormInstance) ModifyStep(step domain.Step) domain.Step {
...
func (g GormInstance) ModifyAccomplishment(accomplishment domain.Accomplishment) domain.Accomplishment {
...
func (g GormInstance) ModifyTask(task domain.Task) domain.Task {
...
func (g GormInstance) ModifyCycle(cycle domain.Cycle) domain.Cycle {
...
func (g GormInstance) ModifyResource(resource domain.Resource) domain.Resource {
